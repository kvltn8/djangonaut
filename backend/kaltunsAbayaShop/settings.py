"""
Django settings for kaltunsAbayaShop project.
...
CORS_ALLOWED_ORIGINS = os.getenv("CORS_ALLOWED_ORIGNS","http://localhost:5173").split(".")
...
WSGI_APPLICATION = 'kaltunsAbayaShop.wsgi.application'
